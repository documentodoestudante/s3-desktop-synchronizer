...
public class GlobalConstants {
    ...
    public static String REGION = "Região";
    public static String OWNER = "Convênio";
    public static String TITULO = "Sincronizador de arquivos";
    public static String SYNC = "Sincronizar";
    public static String SAVE_IN = "Salvar em";
    public static String SAVE = "Salvar";
    public static String CANCEL = "Cancelar";
    public static String CONFIGURE = "Configurar";
    public static String LOADING_GIF_URL = "https://s3-sa-east-1.amazonaws.com/dne-convenios/loader.gif";
    public static String FILL_THE_BLANKS = "Preencha todos os campos";
